...
MODEL_URLS = {
    ...
    "sam2": "https://github.com/ultralytics/assets/releases/download/v8.3.0/sam2.1_t.pt",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--models", nargs="+", choices=[*MODEL_URLS, "openclip", "birefnet", "flux", "sana"])
...
def main() -> int:
    args = parse_args()
    selected = list(MODEL_URLS) + ["openclip", "birefnet", "sana"] if args.all else (args.models or [])
    if not selected:
