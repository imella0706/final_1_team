...
class Settings(BaseSettings):
    ...
    openai_gpt_5_5_model: str = "gpt-4.1-mini"
    openai_gpt_5_4_model: str = "gpt-4.1-mini"
    openai_gpt_5_4_mini_model: str = "gpt-4.1-mini"
    openai_gpt_5_4_nano_model: str = "gpt-4.1-mini"
    openai_gpt_4_1_mini_model: str = "gpt-4.1-mini"
    openai_tts_model: str = "gpt-4o-mini-tts"
    openai_tts_fallback_models: str = "tts-1-hd,tts-1"
    openai_tts_voice: str = "coral"
    openai_tts_format: str = "mp3"
    openai_tts_timeout_seconds: float = 120
    voice_provider: str = "openai"
    cosyvoice_base_url: str = "http://127.0.0.1:50000"
    cosyvoice_model: str = "Fun-CosyVoice3-0.5B-2512"
    cosyvoice_timeout_seconds: float = 180
    cosyvoice_health_timeout_seconds: float = 2
    cosyvoice_fallback_to_openai: bool = True
