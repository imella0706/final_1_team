...
airflow_append_default_env_values() {
  ...
  airflow_ensure_env_value "BRANDMATE_SNS_TREND_YOUTUBE_LANDING_SCHEDULE" "48 19 * * 3"
  airflow_ensure_env_value "BRANDMATE_SNS_TREND_YOUTUBE_LANDING_LIMIT" "100"
  airflow_ensure_env_value "BRANDMATE_SNS_TREND_GOGUMAFARM_LANDING_SCHEDULE" "48 19 * * 3"
  airflow_ensure_env_value "BRANDMATE_SNS_TREND_CAREET_LANDING_SCHEDULE" "48 19 * * 3"
